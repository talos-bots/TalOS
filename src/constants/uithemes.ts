...
lightModeSolid.themeItalic = 'rgb(197, 196, 196)';
...
lightModeSolid.themeBackground = "url('./backgrounds/lightdefault.svg')";  // You'd need an appropriate gray background SVG.
...
solidOrange.themeItalic = 'rgb(197, 196, 196)';
...
darkModeSolid.themeItalic = 'rgb(197, 196, 196)';
...
darkModeSolid.themeBackground = "url('./backgrounds/blackdefault.svg')"; 
