...
const ConstructProfile: React.FC<Props> = ({character, onClick}) => {
    ...
    return (
        <div className="themed-root-no-padding w-10vw h-full flex flex-col justify-center items-center relative" onClick={() => {if(onClick !== undefined) onClick()}}>
            <img src={characterImage} alt={characterName} className="cursor-pointer object-cover w-full h-full rounded-lg"/>
