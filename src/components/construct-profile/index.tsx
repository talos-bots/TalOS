...
const ConstructProfile: React.FC<Props> = ({character, onClick}) => {
    ...
    return (
        <div className="themed-root-no-padding w-10vw h-full flex flex-col justify-center items-center cursor-pointer relative" onClick={() => {if(onClick !== undefined) onClick(character)}}>
