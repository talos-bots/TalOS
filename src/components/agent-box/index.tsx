            ...
            <div className="grid grid-cols-5 gap-4">
                <div className="col-span-1">
                    <Link to={`/agents/${character._id}`}>
                        {characterImage === '' ? <RiQuestionMark className="agent-image-default"/> : <img src={characterImage} alt={characterName} className="cursor-pointer object-scale-down rounded-theme-border-radius"/>}
