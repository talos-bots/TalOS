  ...
  return (
    <div>
      <div className={`rounded-full bg-black bg-opacity-25 backdrop-blur-sm box-border w-[1151px] h-[51px] overflow-hidden shrink-0 flex flex-row py-0 px-2.5 items-center justify-start gap-[23px] border-[1px] border-solid border-lime-200`}>
        <button className={`cursor-pointer p-0 bg-lime-200 relative rounded-3xl w-[35px] h-[35px] overflow-hidden shrink-0 transition-all duration-125 hover:opacity-75 ${attachmentMenuOpen ? "attachment-menu-open" : ""}`} onClick={toggleAttachmentMenu}>
