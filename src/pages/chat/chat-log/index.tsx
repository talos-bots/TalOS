...
const ChatLog = (props: ChatLogProps) => {
	...
	return (
		<>
			...
			<div className="col-span-2 box-border h-[calc(100vh-70px)] flex flex-col gap-2 overflow-x-hidden p-4 lg:p-6">
			</div>
			<div className="col-span-4 box-border h-[calc(100vh-70px)] flex flex-col gap-2 overflow-x-hidden p-4 lg:p-6">
			...
			<div className="col-span-2 box-border h-[calc(100vh-70px)] flex flex-col gap-2 overflow-x-hidden pt-4 pb-4 pr-4 lg:p-6">
			{openChatConfig === true && (
