...
const AttachmentsPage = () => {
    ...
    return (
        <div className="w-full h-[calc(100vh-70px)] grid grid-rows-[auto,1fr] overflow-y-auto overflow-x-hidden p-4 gap-2">
            <div className="w-full themed-root pop-in">
                    ...
                    if(attachment.fileext === "png" || attachment.fileext === "jpg" || attachment.fileext === "jpeg" || attachment.fileext === "gif" || attachment.fileext === "webp" || attachment.fileext === "svg"){
                        return (
                            <div className="col-span-1 w-full h-full themed-root flex flex-col justify-center items-center gap-2 aspect-square pop-in">
                                ...
                                <img src={getAttachmentData(attachment)} className="w-full h-full object-contain rounded-theme-border-radius object-cover bg-theme-box border-theme-border-width border-theme-border"/>
                                <p>
